...
title: SUM
slug: MJ_q-sum
description: The SUM function calculates the sum of the specified values. This article covers the detailed case by case examples on the functionalities of SUM.
