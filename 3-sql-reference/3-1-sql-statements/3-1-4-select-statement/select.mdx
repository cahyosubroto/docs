...
<Check>All the examples below are executed in the `public` schema. You can also display table from another specific schema. Click [here](https://oxla.mintlify.app/3-sql-reference/schema) for more info.</Check>
