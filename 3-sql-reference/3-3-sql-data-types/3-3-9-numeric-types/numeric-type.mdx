---
title: Numeric Type
slug: WX6x-numeric-type
description: Numeric is a data type that stores numbers. This article covers the overview and four types of Numeric data types. Let's go over the details with examples.
