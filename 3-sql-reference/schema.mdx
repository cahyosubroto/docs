...
From [Example #1](https://oxla.mintlify.app/3-sql-reference/schema#example-1), we created a new schema and a table. Use the command below to delete the schema and also the tables in it:
