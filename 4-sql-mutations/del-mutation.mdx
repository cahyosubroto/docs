...
The mutation deletes one or more records from a table based on specified conditions. This support has limitations:

1.  Only **one data mutation** at a given moment is possible, trying to run another one will fail.
...
We are aiming to enhance and optimize this feature in future updates!</Check>

## **Syntax**

The syntax for mutation is as follows:
