...
The `` mutation is used to modify the existing records in a table. This support has limitations:
...
<Check>**Feature Update: Initial Release**

<Check>**Feature Update: Initial Release** This marks the initial release of our new Mutation feature, providing you with the ability to update data. The Mutations involve rewriting entire files which take several minutes and could generate infrastructure costs. We are aiming to enhance and optimize this feature in future updates!</Check>
