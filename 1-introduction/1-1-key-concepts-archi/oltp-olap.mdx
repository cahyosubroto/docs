...
<Tip>The main purpose is data processing and not data analysis./Tip>
...
<Tip>The main objective is data analysis and not data processing./Tip>
...
<Note>**Did you know?🧐** The Microsoft Excel and Microsoft SQL Server’s Analysis Services are also using OLAP features!</Note>
