...
<AccordionGroup>
  <Accordion title="ADDED" icon="plus" iconType="solid">
...
<AccordionGroup>
  ...
  <Accordion title="CHANGED" icon="pen-nib" iconType="solid">
  ...
  <Accordion title="FIXED" icon="screwdriver-wrench" iconType="solid">
...
<AccordionGroup>
  ...
  <Accordion title="TEMPORARY COMPATIBILITY ISSUES" icon="bug" iconType="solid">
