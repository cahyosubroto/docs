---
title: OUTER JOIN
slug: Z18d-outer-join
description: The OUTER JOIN or FULL OUTER JOIN returns all the records from the selected fields between two tables whether the join condition is met or not. More here.
