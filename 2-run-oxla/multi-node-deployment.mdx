...
<Info>Please replace `IP\_ADDRESS` with one of the IP addresses that you setup in your yaml file. If you encounter an error response “bash: psql: command not found“, this means that you have not installed PostgreSQL.</Info>
