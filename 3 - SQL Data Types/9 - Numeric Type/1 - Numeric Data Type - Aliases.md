...
slug: noxW-numeric-data-type-aliases
description: In this guide, we go through a Numeric Data Type, Aliases. Let's discuss the four aliases, which can be used interchangeably with primary data types.
