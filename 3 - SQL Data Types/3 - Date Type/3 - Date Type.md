...
title: Date Type
slug: 1Bru-date-type
description: The DATE data type is used to store and insert date values using three components: year, month, and day. We'll be going over more in this guide.
